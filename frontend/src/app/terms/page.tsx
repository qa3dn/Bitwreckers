...
import { FileText, Scale, AlertTriangle, CheckCircle, Users } from 'lucide-react';
...
export default function TermsPage() {
  ...
  const termsSections = [
    ...
    {
      icon: Users,
      title: t('terms.useLicense.title'),
      content: t('terms.useLicense.content')
    },
    {
      icon: AlertTriangle,
    ...
    <div className={`min-h-screen bg-gradient-to-br from-gray-900 via-[#131422] to-gray-900 ${isRTL ? 'font-arabic' : 'font-english'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        ...
        >
          ...
          >
            <Scale className="w-5 h-5 text-[#b376bf]" />
            <span className="text-[#b376bf] font-semibold">{t('terms.title')}</span>
          </motion.div>
