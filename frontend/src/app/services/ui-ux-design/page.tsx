...
import { Palette, Eye, Users, Zap, Shield, Globe, Rocket, CheckCircle, ArrowRight, PenTool } from 'lucide-react';
...
export default function UIUXDesignPage() {
  ...
  const technologies = [
    { name: 'Figma', icon: <Palette className="w-6 h-6" />, description: 'Design Tool' },
    { name: 'Adobe XD', icon: <Eye className="w-6 h-6" />, description: 'Prototyping' },
    { name: 'Sketch', icon: <PenTool className="w-6 h-6" />, description: 'Vector Design' },
    { name: 'InVision', icon: <Globe className="w-6 h-6" />, description: 'Collaboration' },
    { name: 'Principle', icon: <Zap className="w-6 h-6" />, description: 'Animation' },
    { name: 'Photoshop', icon: <Shield className="w-6 h-6" />, description: 'Image Editing' }
  ];

  const features = [
    {
      icon: <Users className="w-8 h-8" />,
      title: t('services.uiux.userCenteredTitle'),
      description: t('services.uiux.userCenteredDescription')
    },
    {
      icon: <Eye className="w-8 h-8" />,
      title: t('services.uiux.visualDesignTitle'),
      description: t('services.uiux.visualDesignDescription')
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: t('services.uiux.interactionTitle'),
      description: t('services.uiux.interactionDescription')
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: t('services.uiux.responsiveTitle'),
      description: t('services.uiux.responsiveDescription')
    }
  ];

  const teamMembers = [
    { name: 'Mohammad Al Khaldi', role: 'UI/UX Team', specialization: 'User Experience Design' },
    { name: 'Taimaa Bany Ahmad', role: 'Frontend Developer', specialization: 'UI Implementation' },
    { name: 'Mohammad Ibdaah', role: 'Frontend Developer', specialization: 'Interactive Design' },
    { name: 'Ahmad Obaidawi', role: 'Frontend Developer', specialization: 'Visual Design' }
  ];

  const processSteps = [
    {
      number: '01',
      title: t('services.uiux.researchTitle'),
      description: t('services.uiux.researchDescription'),
      icon: <Users className="w-6 h-6" />
    },
    {
      number: '02',
      title: t('services.uiux.wireframingTitle'),
      description: t('services.uiux.wireframingDescription'),
      icon: <PenTool className="w-6 h-6" />
    },
    {
      number: '03',
      title: t('services.uiux.designTitle'),
      description: t('services.uiux.designDescription'),
      icon: <Palette className="w-6 h-6" />
    },
    {
      number: '04',
      title: t('services.uiux.testingTitle'),
      description: t('services.uiux.testingDescription'),
    ...
    <div className={`min-h-screen bg-gradient-to-br from-[#0f0f1b] via-[#131422] to-[#1a1a2e] text-white overflow-hidden ${isRTL ? 'font-arabic' : 'font-english'}`} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.uiux.technologiesTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.uiux.technologiesSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#6B2D73]/10 to-[#2D7363]/10">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.uiux.featuresTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.uiux.featuresSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.uiux.teamTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.uiux.teamSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#6B2D73]/10 to-[#2D7363]/10">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.uiux.processTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.uiux.processSubtitle')}
            </p>
          </motion.div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.uiux.ctaTitle')}
            </h3>
            <p className="text-xl text-[#F8F8F8] mb-8">
              {t('services.uiux.ctaSubtitle')}
            </p>
