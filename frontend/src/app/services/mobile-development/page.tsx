...
import { Smartphone, Code, Zap, Shield, Database, Globe, Users, Rocket, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function MobileDevelopmentPage() {
  ...
  const technologies = [
    { name: 'Flutter', icon: <Smartphone className="w-6 h-6" />, description: 'Cross-Platform' },
    { name: 'React Native', icon: <Code className="w-6 h-6" />, description: 'Native Performance' },
    { name: 'Dart', icon: <Zap className="w-6 h-6" />, description: 'Modern Language' },
    { name: 'Firebase', icon: <Database className="w-6 h-6" />, description: 'Backend Services' },
    { name: 'Android Studio', icon: <Globe className="w-6 h-6" />, description: 'Development IDE' },
    { name: 'Xcode', icon: <Shield className="w-6 h-6" />, description: 'iOS Development' }
  ];

  const features = [
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: t('services.mobile.crossPlatformTitle'),
      description: t('services.mobile.crossPlatformDescription')
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: t('services.mobile.performanceTitle'),
      description: t('services.mobile.performanceDescription')
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: t('services.mobile.securityTitle'),
      description: t('services.mobile.securityDescription')
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: t('services.mobile.integrationTitle'),
      description: t('services.mobile.integrationDescription')
    }
  ];

  const teamMembers = [
    { name: 'Yaman Gharaibeh', role: 'Flutter Developer', specialization: 'Cross-Platform Apps' },
    { name: 'Rama Al rabaa', role: 'Flutter Developer', specialization: 'UI/UX Implementation' },
    { name: 'Hashem ALghazawi', role: 'Flutter Developer', specialization: 'State Management' },
    { name: 'Lina Khdeir', role: 'Full Stack Developer', specialization: 'Backend Integration' }
  ];

  const processSteps = [
    {
      number: '01',
      title: t('services.mobile.planningTitle'),
      description: t('services.mobile.planningDescription'),
      icon: <Users className="w-6 h-6" />
    },
    {
      number: '02',
      title: t('services.mobile.designTitle'),
      description: t('services.mobile.designDescription'),
      icon: <Smartphone className="w-6 h-6" />
    },
    {
      number: '03',
      title: t('services.mobile.developmentTitle'),
      description: t('services.mobile.developmentDescription'),
      icon: <Code className="w-6 h-6" />
    },
    {
      number: '04',
      title: t('services.mobile.deploymentTitle'),
      description: t('services.mobile.deploymentDescription'),
    ...
    <div className={`min-h-screen bg-gradient-to-br from-[#0f0f1b] via-[#131422] to-[#1a1a2e] text-white overflow-hidden ${isRTL ? 'font-arabic' : 'font-english'}`} dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            >
              ...
              >
                <span className="relative z-10 flex items-center gap-3">
                  ...
                  {t('services.mobile.startProject')}
                </span>
              </motion.button>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.mobile.technologiesTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.mobile.technologiesSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#6B2D73]/10 to-[#2D7363]/10">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.mobile.featuresTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.mobile.featuresSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.mobile.teamTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.mobile.teamSubtitle')}
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#6B2D73]/10 to-[#2D7363]/10">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.mobile.processTitle')}
            </h2>
            <p className="text-xl text-[#F8F8F8]/80 max-w-3xl mx-auto">
              {t('services.mobile.processSubtitle')}
            </p>
          </motion.div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <h3 className="text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-[#b376bf] to-[#d4aad9] bg-clip-text text-transparent">
              {t('services.mobile.ctaTitle')}
            </h3>
            <p className="text-xl text-[#F8F8F8] mb-8">
              {t('services.mobile.ctaSubtitle')}
            </p>
