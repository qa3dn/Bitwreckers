...
const testimonials = [
  {
    ...
    quote: 'Bitwreckers transformed our vision into a stunning reality. Their attention to detail and innovative approach exceeded our expectations.',
    logo: '🏢'
  },
  {
    id: 2,
    ...
    image: '/api/placeholder/100/100',
    quote: 'The AI solution they built for us revolutionized our data processing capabilities. Incredible results!',
    logo: '📊'
  },
  {
    id: 3,
    ...
    company: 'FitLife App',
    image: '/api/placeholder/100/100',
    quote: 'From concept to launch, Bitwreckers delivered a world-class mobile app that our users love.',
    logo: '💪'
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            A showcase of projects we built with passion, innovation, and impact.
          </motion.p>
        </div>
      </section>
            ...
            <AnimatePresence mode="wait">
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  {/* Glow Effect */}
                  <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 bg-gradient-to-r from-red-500 to-orange-600 blur-xl" />
                </motion.div>
              ))}
            </AnimatePresence>
          </motion.div>
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-gray-900/50 backdrop-blur-xl rounded-3xl border border-gray-700/50 p-8 md:p-12"
              >
                <div className="text-center">
                  <div className="flex items-center justify-center gap-4 mb-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-orange-600 rounded-full flex items-center justify-center text-2xl">
                  ...
                  <p className="text-red-400 font-semibold">{testimonials[currentTestimonial].company}</p>
                </div>
              </motion.div>
            </AnimatePresence>
          ...
          >
            ...
            >
              ...
              <div className="relative h-64 md:h-80 bg-gradient-to-br from-gray-800 to-gray-900 rounded-t-3xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-gradient-to-r from-red-500 to-orange-600 rounded-full flex items-center justify-center mb-4 mx-auto">
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedProject.technologies.map((tech, index) => (
                      <span
                        key={index}
                        className="px-3 py-1 bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 rounded-full text-sm text-red-300"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div className="mb-8">
                  ...
                  <p className="text-orange-400 text-lg font-semibold">{selectedProject.impact}</p>
                </div>

                {/* Action Buttons */}
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.button
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-orange-600 text-white rounded-xl font-semibold hover:from-red-600 hover:to-orange-700 transition-all duration-300"
