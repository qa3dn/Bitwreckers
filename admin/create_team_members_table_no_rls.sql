-- Create team_members table (No RLS version for testing)
-- This script creates the table without Row Level Security for easier testing

-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Allow public read access to active team members" ON team_members;
DROP POLICY IF EXISTS "Allow admin full access to team_members" ON team_members;
...
SELECT 'Team members table setup completed successfully without RLS!' as message;
