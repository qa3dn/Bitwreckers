-- Create team_members table (Secure version with proper RLS)
-- This script creates a secure setup with proper authentication
...
-- This is more permissive but safer than trying to access auth.users
CREATE POLICY "Allow authenticated users full access" ON team_members
...
SELECT 'Team members table setup completed successfully with secure RLS!' as message;
